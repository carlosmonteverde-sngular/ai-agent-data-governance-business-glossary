...
def main(project_id=PROJECT_ID, location=LOCATION, target_dataset=TARGET_DATASET, glossary_id="business-glossary-v1", glossary_display_name="Business Glossary"):
